                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <div className="relative h-64 md:h-80">
                        <Image
                          ...
                          unoptimized
                        />
                        <div className="absolote inset-0 bg-black/40 flex items-center justify-center">
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <h3 className="text-xl font-bold text-gray-800 mb-3">Nuestra misión</h3>
                        <p className="text-gray-600 leading-relaxed mb-6">
                        ...
                        <div className="bg-primary/10 p-6 rounded-lg text-center mt-8"> 
                          ...
                          <Link
                          href="/cotizar"
                          className='inline-block bg-primary text-white px-6 py-2 rounded-md hover:bg-secondary transition-colors'> Solicita una Cotización </Link>
                        </div>
                    </div>
                </div>
            </div>
